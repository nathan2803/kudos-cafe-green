-- Insert sample orders for the past week using only the existing user ID and guest orders
...
-- June 8, 2025 (Tuesday)
(NULL, 62.00, 'delivered', 'paid', 'takeout', 'Mike Wilson', '+1234567891', 'mike.wilson@example.com', 'No onions', 0, 0, '2025-06-08 12:15:00', '2025-06-08 13:00:00'),
...
(NULL, 89.25, 'delivered', 'paid', 'takeout', 'David Brown', '+1234567892', 'david.brown@example.com', 'Office delivery', 0, 0, '2025-06-09 13:30:00', '2025-06-09 14:15:00'),
...
-- June 11, 2025 (Friday)
(NULL, 112.50, 'delivered', 'paid', 'takeout', 'Alex Garcia', '+1234567894', 'alex.garcia@example.com', 'Weekend family order', 0, 0, '2025-06-11 19:15:00', '2025-06-11 20:00:00'),
...
-- June 13, 2025 (Sunday)
(NULL, 95.75, 'delivered', 'paid', 'takeout', 'Alex Garcia', '+1234567894', 'alex.garcia@example.com', 'Sunday family meal', 0, 0, '2025-06-13 17:00:00', '2025-06-13 17:45:00'),
...
-- June 14, 2025 (Today)
(NULL, 76.25, 'preparing', 'paid', 'takeout', 'David Brown', '+1234567892', 'david.brown@example.com', 'Monday dinner', 0, 0, '2025-06-14 18:30:00', '2025-06-14 18:30:00'),
...
-- Insert sample reservations for the existing user
INSERT INTO public.reservations (user_id, table_id, party_size, reservation_date, reservation_time, status, special_requests, deposit_amount, created_at, updated_at) VALUES
-- Past reservations
('88cbf59c-bc40-49ca-848b-edb934fe3203', (SELECT id FROM public.tables WHERE table_number = 3), 4, '2025-06-07', '18:00:00', 'completed', 'Anniversary dinner', 25.00, '2025-06-07 10:00:00', '2025-06-07 22:00:00'),
('88cbf59c-bc40-49ca-848b-edb934fe3203', (SELECT id FROM public.tables WHERE table_number = 6), 8, '2025-06-08', '19:00:00', 'completed', 'Birthday celebration', 50.00, '2025-06-08 09:00:00', '2025-06-08 23:00:00'),
('88cbf59c-bc40-49ca-848b-edb934fe3203', (SELECT id FROM public.tables WHERE table_number = 2), 6, '2025-06-09', '12:00:00', 'completed', 'Business lunch', 30.00, '2025-06-09 08:00:00', '2025-06-09 15:00:00'),
('88cbf59c-bc40-49ca-848b-edb934fe3203', (SELECT id FROM public.tables WHERE table_number = 6), 10, '2025-06-11', '20:00:00', 'completed', 'Friday night celebration', 75.00, '2025-06-11 11:00:00', '2025-06-11 23:30:00'),
('88cbf59c-bc40-49ca-848b-edb934fe3203', (SELECT id FROM public.tables WHERE table_number = 5), 8, '2025-06-12', '11:30:00', 'completed', 'Weekend brunch', 40.00, '2025-06-12 09:00:00', '2025-06-12 14:30:00'),
('88cbf59c-bc40-49ca-848b-edb934fe3203', (SELECT id FROM public.tables WHERE table_number = 6), 10, '2025-06-13', '18:30:00', 'completed', 'Sunday special dinner', 65.00, '2025-06-13 12:00:00', '2025-06-13 22:00:00'),

-- Today's and future reservations
('88cbf59c-bc40-49ca-848b-edb934fe3203', (SELECT id FROM public.tables WHERE table_number = 5), 6, '2025-06-14', '19:00:00', 'confirmed', 'Evening reservation', 45.00, '2025-06-14 14:00:00', '2025-06-14 19:15:00'),
('88cbf59c-bc40-49ca-848b-edb934fe3203', (SELECT id FROM public.tables WHERE table_number = 3), 4, '2025-06-15', '18:30:00', 'confirmed', 'Weekend dinner', 30.00, '2025-06-14 16:00:00', '2025-06-14 16:00:00'),
('88cbf59c-bc40-49ca-848b-edb934fe3203', (SELECT id FROM public.tables WHERE table_number = 2), 2, '2025-06-16', '12:00:00', 'pending', 'Lunch meeting', 20.00, '2025-06-14 11:00:00', '2025-06-14 11:00:00');